...
void run_app(int count, char* arg[]) {
    ...
    struct AppParams ap_pr = {
        .a = 50,            // линейный коэфцент Uvx
	    .b = 0.07,			// линейный коэфцент Uvx
	    .c = 0.1,			// линейный коэфцент Uvx
	    .d = 1.2,			// линейный коэфцент Uvx
        .tn = 15,           // Начальное время tn
        .t1 = 30,			// Момент времени t1
        .t2 = 50,			// Момент времени t2
        .tk = 100,          // Конечное время tk

		.a_vix = 5,			// линейный коэфцент Uvix
		.b_vix = 0.05,		// линейный коэфцент Uvix
		.Uvx1 = 10,			// линейный коэфцент Uvix
